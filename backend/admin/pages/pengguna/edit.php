...
try {
    $stmt = $pdo->prepare("SELECT id, nama, email, role FROM users WHERE id = :id");
    $stmt->execute([':id' => $id]);
            ...
            <div class="page-inner">
                ...
                <div class="page-header mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Perbarui data informasi akun peminjam</p>
                    </div>
                        ...
                        <div class="card card-round shadow-sm">
                            <div class="card-header bg-white py-3">
                                <div class="card-title fw-bold text-primary m-0">
                                    <i class="fas fa-user-edit me-2"></i> Form Ubah Data Akun
                                </div>
                            </div>
                            ...
                            <form action="proses_edit.php" method="POST">
                                ...
                                <div class="card-body px-4 py-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama" id="nama" class="form-control" value="<?= htmlspecialchars($user['nama'], ENT_QUOTES, 'UTF-8') ?>" required>
                                    </div>

                                    <div class="mb-3">
                                        <label for="email" class="form-label fw-bold">Email (Username) <span class="text-danger">*</span></label>
                                ...
                                <div class="card-action bg-light px-4 py-3 text-end rounded-bottom">
                                    ...
                                    <button type="submit" class="btn btn-success px-4">
                                        <i class="fas fa-save me-1"></i> Perbarui Akun
                                    </button>
                                </div>
                            </form>
                        </div>
